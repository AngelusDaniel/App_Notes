                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old("text_title", $note->title)}}" class="form-control bg-primary text-white" name="text_title">
                        ...
                        <div class="mb-3">
                            ...
                            @if($errors->any())
                                <small style="color: red">{{$errors->first("text_note")}}</small>
                            @endif
                        </div>
                    </div>
                </div>
